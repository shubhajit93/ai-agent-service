...
import org.hishab.agent.cmd.api.dto.agent.AgentTtsRequest;
...
public class TtsValidator {
    ...
    public void isValidTtsInformation(AgentTtsRequest ttsRequest, ValidationType validationType) throws AgentException {
